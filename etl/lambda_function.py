...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
                Name='EMR-Gustavo-IGTI-delta2',
                ServiceRole='EMR_DefaultRole',
                JobFlowRole='EMR_EC2_DefaultRole',
                VisibleToAllUsers=True,
                LogUri='s3://datalake-igti-gustavo-tf/emr-logs',
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': [
                            ...
                            '--conf', 'spark.sql.extensions=io.delta.sql.DeltaSparkSessionExtension', 
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-igti-gustavo-tf/emr-code/pyspark/01_delta_spark_insert.py'
                                 ]
                    }
                },
                {
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                #  '--packages', 'io.delta:delta-core_2.12:1.1.0',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-igti-gustavo-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                                 ]
                    }
                }],
            )
